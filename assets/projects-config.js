...
const PROJECTS_CONFIG = [
  ...
  /* ── 1. MASTER MEC ── */
  {
    ...
    titleEn: "Master MEC",
    subtitleEn: "Art direction & photo shoot",
    descriptionEn: "Art direction and production of a professional photo shoot. Staging, model coordination (Anne, JC, Sandrine) and post-production of visuals.",
    tagsEn: ["Shooting", "Oral presentation", "Photo"],
    tagColor: "red",
  ...
  /* ── 2. POWER BI ── */
  {
    ...
    titleEn: "Power BI",
    subtitleEn: "Dashboards & Data Analysis",
    descriptionEn: "Design of interactive Power BI dashboards for direct marketing campaign tracking, KPI analysis and weekly reporting to management.",
    tagsEn: ["Data", "Dashboards", "Reporting"],
    tagColor: "blue",
  ...
  /* ── 3. POULET MIKAT ── */
  {
    ...
    titleEn: "Poulet Mikat",
    subtitleEn: "Branding & Complete Visual Identity",
    descriptionEn: "Complete visual identity for this Congolese cuisine restaurant: brand guidelines (2 logos), flyers, drinks menu and loyalty card. \"Africa at your doorstep.\"",
    tagsEn: ["Full Branding", "Visual Identity", "Social Media"],
    tagColor: "orange",
    ...
    images: [
      ...
      /* ── Médias ajoutés le 30 avril 2026 ── */
      // ⚠️ À activer quand les fichiers seront copiés dans le dossier :
  ...
  /* ── 4. DAMCOMPANY ── */
  {
    ...
    titleEn: "DamCompany",
    subtitleEn: "Web agency & digital development",
    descriptionEn: "Collaboration with DamCompany agency for the design and development of professional websites. Design, integration and deployment of tailor-made digital solutions.",
    tagsEn: ["Web", "Design", "Digital"],
    tagColor: "gold",
  ...
  /* ── 5. MA1 ── */
  {
    ...
    titleEn: "MA1",
    subtitleEn: "Your personal road assistant",
    descriptionEn: "Logo creation and visual identity for MA1 — an artificial intelligence application for drivers.",
    tagsEn: ["Logo", "Tech & AI", "Automotive"],
    tagColor: "blue",
  ...
  /* ── 6. VTCSR ── */
  {
    ...
    titleEn: "VTCSR",
    subtitleEn: "Website & Visual Communication",
    descriptionEn: "Website mockup, business cards and communication materials for VTCSR, a private hire vehicle company in Roissy-en-Brie.",
    tagsEn: ["Website", "Business Card", "VTC"],
    tagColor: "teal",
  ...
  /* ── 7. KINGBREL ── */
  {
    ...
    titleEn: "Kingbrel",
    subtitleEn: "The Brel Attitude — Barbershop",
    descriptionEn: "Business card and loyalty card for \"The Brel Attitude\" barbershop in Livry-Gargan. Premium black & gold style.",
    tagsEn: ["Barbershop", "Loyalty", "Black & Gold"],
    tagColor: "gold",
  ...
  /* ── 8. TOKYO ZEN ── */
  {
    ...
    titleEn: "Tokyo Zen",
    subtitleEn: "Massage & Wellness",
    descriptionEn: "Business card and service menu for a massage & wellness institute in Île-de-France. Clean design in earth and ivory tones.",
    tagsEn: ["Wellness", "Business Card", "Price List"],
    tagColor: "beige",
  ...
  /* ── 9. IL RESTAURE ENCORE ── */
  {
    ...
    titleEn: "He restores again!",
    subtitleEn: "Women's voices — Gabriella Ibata",
    descriptionEn: "Promotional visual for \"Women's voices\" by Gabriella Ibata — a collection of testimonies, a cry of hope and faith. Available on Amazon.fr.",
    tagsEn: ["Testimonies", "Women", "Spirituality"],
    tagColor: "purple",
  ...
  /* ── 10. DESTINÉE ── */
  {
    ...
    titleEn: "Destinée",
    subtitleEn: "The path — Book 1 · Manyinga Serge",
    descriptionEn: "Promotional visuals and communication materials for the novel \"Destinée – The path, Book 1\" by Manyinga Serge. Available on Amazon.",
    tagsEn: ["Book Promotion", "Amazon", "Art Direction"],
    tagColor: "green",
  ...
  /* ── 11. SDG ── */
  {
    ...
    titleEn: "SDG",
    subtitleEn: "Creative project & communication",
    descriptionEn: "Visual creation and communication materials for the SDG project. Clean and consistent graphic identity across all produced materials.",
    tagsEn: ["Design", "Creativity", "Communication"],
    tagColor: "purple",
  ...
  /* ── 12. NOUVEAU PROJET ── */
  {
    ...
    tags: ["Coming soon"],
    titleEn: "New project",
    subtitleEn: "Being updated ✨",
    descriptionEn: "Next creative project coming soon. Stay tuned!",
    tagsEn: ["Coming soon"],
    tagColor: "silver",
